...
if(isset($_POST['modify']))
{
    ...
    $lab=$_POST['lab'];
    $result5 = mysqli_query($con,'update faculty set name="'.$name.'",email="'.$email.'",subject="'.$subject.'",lab="'.$lab.'" where faculty_id="'.$id1.'"');
    $name="";
    $email="";
    $subject="";
    $lab="";
...
{
  $id1=$_SESSION['id'];
  $result6 = mysqli_query($con,'delete from faculty where faculty_id="'.$id1.'"');
  $error=2;
  $name="";
  $email="";
  $subject="";
  ...
  <body>
    ...
    {?>
      <script type="text/javascript">
            swal("Congrats!", "Faculty data has been modified successfully!", "success");
          </script>
      <?php
      $error=-1;
    }
    elseif ($error==2) {
      ?>
      <script type="text/javascript">
            swal("Congrats!", "Faculty data has been deleted successfully!", "success");
          </script>
      <?php
      $error=-1;
    }
    ...
    <div class="wrapper">
      ...
      <main class="page-main">
        <div class="container">
          ...
          <table>
            <caption>Modify / Remove Faculty Data</caption>
            ...
            <tbody>
              ...
              <select name="id">
                <?php
                  $result3 = mysqli_query($con,'select * from faculty');
            ...
            <div class="logout">
              ...
              <input type="submit" name="selectfaculty" value="Select">                  
            </div>
          </th>
            </form>
              <form method="POST">
