...
if(isset($_POST['submit']))
{
    ...
    {
        $result = mysqli_query($con,"INSERT into student (student_id,name,email,password,subject,lab) values ('$id','$name','$email','$password','$subject','$lab')");
        $error=1;
    }
    else
    {
...
<html>
  ...
  <body>
    ...
    {?>
      <script type="text/javascript">
          swal("Sorry!", "Student already exists!", "error");
        </script>
      <?php
      $error=-1;
    }
            ...
            <tbody>
              <form method="POST">
                <tr>
                  ...
                  <td>
                    <div class="textbox">
                      <input type="number" name="id" placeholder="Enter Student Id" class="nice" required>
                    </div>
                  </td>
                </tr>
                <tr>
