    ...
    <div class="wrapper">
      ...
      <main class="page-main">
        <div class="container">
          ...
          <center>
            <div class="logout">
              <input type="submit" name="logout" onclick="location.href='addstudent.php'"  value="Add">&nbsp;
              <input type="submit"  onclick="location.href='modifystudent.php'" value="Modify / Remove">                  
            </div><br>
